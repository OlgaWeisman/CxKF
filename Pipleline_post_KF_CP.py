        ...
        for ti in range(0, self.N_Epochs):
            ...
            for j in range(0, self.N_B):
                ...
                for t in range(0, self.ssModel.T):
                    ...
                    q_train[:, t] = self.model(x_out_training[:, t].detach(), KN_model.dm1x_norm.detach(), KN_model.dm1y_norm.detach())
                # Compute Training Loss
        ...
        for ii in range(0, n_Trails):
            ...
            for j in range(0, num_of_calib):
                ...
                for t in range(0, self.ssModel.T):
                    ...
                    q_test[:, t] = self.model(x_out_test[:, t].detach(), KN_model.dm1x_norm.detach(), KN_model.dm1y_norm.detach())
