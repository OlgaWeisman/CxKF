...
### Design Model ###
####################
r2 = torch.tensor([1.])#torch.tensor([10, 1., 0.1, 1e-2, 1e-3])
...
for index in range(0, len(r2)):
    ...
    [pr_cqr, interval_cqr] = KFTest_cp(sys_model, train_input, train_target, cv_input, cv_target, test_input, test_target)
