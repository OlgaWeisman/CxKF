...
class KalmanFilter:
    ...
    def __init__(self, SystemModel):
        self.F_First = SystemModel.F_First;
        self.F_T_First = torch.transpose(self.F_First, 0, 1);

        self.F = SystemModel.F_First;
