...
from Pipeline_EKF_BNN import Pipeline_EKF

from Extended_BNN_KalmanNet_nn import KalmanNetNN
...
for index in range(0, len(r)):
    ...
    sys_model_partialh = SystemModel(f, q[index], hInacc, r[index], T, T_test, m, n,"Lor")# arbitary q and r
    sys_model_partialh.InitSequence(m1x_0, m2x_0)
    modelFolder = 'KNet' + '/'
