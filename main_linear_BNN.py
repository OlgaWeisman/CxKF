...
from Pipeline_KF_BNN_withCov import Pipeline_KF_E
from BNN_withcov_linear_KalmanNet_nn import KalmanNetNN_E
...
for index in range(0, len(r2)):
    ...
    modelFolder = 'KNet_new' + '/'
    KNet_Pipeline = Pipeline_KF_E(strTime, "KNet_new", "KNet_" + dataFileName[index])
    KNet_Pipeline.setssModel(sys_model)
    KNet_model = KalmanNetNN_E()
    KNet_model.Build(sys_model)
    KNet_Pipeline.setModel(KNet_model)
    KNet_Pipeline.setTrainingParams(n_Epochs=500, n_Batch=10, learningRate=1E-4, weightDecay=1E-5,num_of_mc_iterations = 50)
    ...
    modelFolder = 'KNet_new' + '/'
    KNet_Pipeline = Pipeline_KF_E(strTime, "KNet", "KNetPartial_" + dataFileName[index])
    KNet_Pipeline.setssModel(sys_model)
    KNet_model = KalmanNetNN_E()
    KNet_model.Build(sys_model)
    KNet_Pipeline.setModel(KNet_model)
