...
def KFTest(SysModel, train_input, train_target, cv_input, cv_target, test_input, test_target,first_method):
    # LOSS
    ...
    if first_method:
        ...
        alpha_err = np.max(err/KF.T_test, axis=1)
