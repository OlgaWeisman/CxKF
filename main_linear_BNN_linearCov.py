...
from Pipeline_KF_BNN_withLinearCov import Pipeline_KF
from BNN_linear_withLinearCov_KalmanNet_nn import KalmanNetNN
...
for index in range(0, len(r2)):
    ...
    KNet_Pipeline = Pipeline_KF(strTime, "KNet_new", "KNet_" + dataFileName[index])
