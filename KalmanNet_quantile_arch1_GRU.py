...
class KalmanNetNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.new_head_in_shape = 3 # Insert also delta x and delta y
    ...
    def step_KGain_est(self, y):
        ...
        # save for second head
        self.dm1y_norm = dm1y_norm
        self.dm1x_norm = dm1x_norm
    ...
    def forward_q_head(self, x, y):
        ...
        #     pass
        # dm1y_norm = self.dm1y_norm.view(1, -1)
        # dm1x_norm = self.dm1x_norm.view(1, -1)
        input = torch.cat([x.view(-1), self.dm1x_norm, self.dm1y_norm], dim=0)
        # ans = self.q_head(x)
    ...
    def forward(self, yt):
        ...
        q = self.forward_q_head(hat_x_t, yt)  # new head
        return hat_x_t, q