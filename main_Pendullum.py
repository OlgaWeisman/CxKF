...
for index in range(0, len(r)):
    ...
    print("Evaluate EKF true")
    [MSE_EKF_linear_arr, MSE_EKF_linear_avg, MSE_EKF_dB_avg, EKF_KG_array, EKF_out] = EKFTest(sys_model_optq,
    ...
    # Evaluate partial_f
    print("Evaluate EKF Partial")
    [MSE_EKF_linear_arr_partialf, MSE_EKF_linear_avg_partialf, MSE_EKF_dB_avg_partialf, EKF_KG_array_partialf,
     EKF_out_partialf] = EKFTest(sys_model_partialf_optq, test_input, test_target)

    print("Evaluate UKF Partial")
    [MSE_UKF_linear_arr_partialf, MSE_UKF_linear_avg_partialf, MSE_UKF_dB_avg_partialf, UKF_out_partialf] = UKFTest(
        sys_model_partialf_optq, test_input, test_target)

    print("Evaluate PF Partial")
    [MSE_PF_linear_arr_partialf, MSE_PF_linear_avg_partialf, MSE_PF_dB_avg_partialf, PF_out_partialf] = PFTest(
        sys_model_partialf_optq, test_input, test_target)
