...
class Pipeline_KF:
    ...
    def NNTrain(self, n_Examples, train_input, train_target, n_CV, cv_input, cv_target):
        ...
        for ti in range(0, self.N_Epochs):
            ...
            x_out_cv_all, cov_out_cv_all = KFTest(self.ssModel, cv_input)
            ...
            x_out_training_all, cov_out_training_all = KFTest(self.ssModel, train_input)
    ...
    def NNCalibrate_Predict(self,n_Calib, n_Trails, calib_input, calib_target, alpha):
        ...
        for ii in range(0, n_Trails):
            ...
            x_out_test_all, cov_out_test_all = KFTest(self.ssModel, calibration_input)
            ...
            x_out_test_all, cov_out_test_all = KFTest(self.ssModel, test_input)
